module "jenkins" {
  ...
  vpc_security_group_ids = ["sg-02b95795ff028bebc"] #replace your SG
  subnet_id = "subnet-005aa77f1a5c7ddb2" #replace your Subnet
...
module "jenkins_agent" {
  ...
  instance_type          = "t3.small"
  vpc_security_group_ids = ["sg-02b95795ff028bebc"]
